package com.entisy.client.util;
...
public class FontRenderer extends CFont {
    ...
    public FontRenderer(String NameFontTTF, int size, int fonttype, boolean antiAlias, boolean fractionalMetrics) {
        super(FontUtil.getFontFromTTF(new ResourceLocation("entisy/fonts/" + NameFontTTF+".ttf"), size,fonttype), antiAlias, fractionalMetrics);
        setupMinecraftColorcodes();
        setupBoldItalicIDs();
    }
